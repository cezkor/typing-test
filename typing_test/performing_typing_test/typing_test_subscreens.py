...
class TypingTestInformationSubscreen:

    def __init__(self, master_window, colored, begin_y: int, begin_x: int):
        ...
        if y > 5:
            self._window = master_window.derwin(5, x, begin_y, begin_x)
        else:
            self._window = None
        self._test_args()
